...
// Create and export the Redux store (named export used by `src/main.jsx`)
...
// Also export `store` as the default export so import styles like
// `import store from './store/store'` or named imports both work and
// esbuild/Vite dependency scanning can detect the export reliably.
